...
public final class JsonUtils {
    ...
    static {
        ...
        OBJECT_MAPPER.registerModule(new SimpleModule().addSerializer(BigDecimal.class, new BigDecimalSerializer()));
        // 忽略BaseEntity的属性
        OBJECT_MAPPER.setFilterProvider(new SimpleFilterProvider().addFilter("IgnoreBaseEntityProperties",
                SimpleBeanPropertyFilter.serializeAllExcept("deleted", "createdDate", "createdBy", "lastModifiedDate", "lastModifiedBy")));
    }
